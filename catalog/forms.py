...
from catalog.models import Rd1ScoreModel, Rd1SlotModel, PlayerModel, SportsTippingModel, FridaySocialModel, SaturdaySocialModel, Rd2ScoreModel, Rd2SlotModel, Rd3ScoreModel, Rd3SlotModel
