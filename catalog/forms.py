...
class Rd1ScoreForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['slot1_score'].widget.attrs={'id': 'player1', 'class':'scoreInputField'}
        self.fields['slot2_score'].widget.attrs={'id': 'player2', 'class':'scoreInputField'}
        self.fields['slot3_score'].widget.attrs={'id': 'player3', 'class':'scoreInputField'}
        self.fields['slot4_score'].widget.attrs={'id': 'player4', 'class':'scoreInputField'}        
        self.fields['slot5_score'].widget.attrs={'id': 'player5', 'class':'scoreInputField'}
        self.fields['slot6_score'].widget.attrs={'id': 'player6', 'class':'scoreInputField'}
        self.fields['slot7_score'].widget.attrs={'id': 'player7', 'class':'scoreInputField'}
        self.fields['slot8_score'].widget.attrs={'id': 'player8', 'class':'scoreInputField'}
        self.fields['slot9_score'].widget.attrs={'id': 'player9', 'class':'scoreInputField'}
        self.fields['slot10_score'].widget.attrs={'id': 'player10', 'class':'scoreInputField'}
        self.fields['slot11_score'].widget.attrs={'id': 'player11', 'class':'scoreInputField'}
        self.fields['slot12_score'].widget.attrs={'id': 'player12', 'class':'scoreInputField'}
